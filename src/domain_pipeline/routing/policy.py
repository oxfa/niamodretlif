...
def _delegation_route_map() -> dict[str, ResultRoute]:
    ...
    return {
        PIPELINE_RESULT_CODE_DELEGATION_EXISTS: ROUTE_FILTERED,
        PIPELINE_RESULT_CODE_DELEGATION_NXDOMAIN: ROUTE_UNACTIONABLE,
        PIPELINE_RESULT_CODE_DELEGATION_NODATA: ROUTE_UNACTIONABLE,
        PIPELINE_RESULT_CODE_DELEGATION_NS_NODATA_SOA_EXISTS: ROUTE_FILTERED,
        PIPELINE_RESULT_CODE_DELEGATION_NS_NODATA_SOA_ABSENT: ROUTE_UNACTIONABLE,
        PIPELINE_RESULT_CODE_DELEGATION_NS_NODATA_SOA_TIMEOUT: ROUTE_REVIEW,
        PIPELINE_RESULT_CODE_DELEGATION_NS_NODATA_SOA_SERVFAIL: ROUTE_REVIEW,
        PIPELINE_RESULT_CODE_DELEGATION_NS_SERVFAIL_SOA_EXISTS: ROUTE_FILTERED,
        PIPELINE_RESULT_CODE_DELEGATION_NO_NAMESERVERS: ROUTE_UNACTIONABLE,
        PIPELINE_RESULT_CODE_DELEGATION_TIMEOUT: ROUTE_REVIEW,
        PIPELINE_RESULT_CODE_DELEGATION_SERVFAIL: ROUTE_REVIEW,
    }
