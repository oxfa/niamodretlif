    ...
    return MappingProxyType(
        {
            ...
            PIPELINE_RESULT_CODE_DNS_DELEGATION_NS_NODATA_SOA_EXISTS: ROUTE_FILTERED,
            PIPELINE_RESULT_CODE_DNS_DELEGATION_NS_NODATA_SOA_ABSENT: ROUTE_UNACTIONABLE,
            PIPELINE_RESULT_CODE_DNS_DELEGATION_NS_NODATA_SOA_TIMEOUT: ROUTE_REVIEW,
            PIPELINE_RESULT_CODE_DNS_DELEGATION_NS_NODATA_SOA_SERVFAIL: ROUTE_REVIEW,
            ...
            PIPELINE_RESULT_CODE_DNS_HOST_RESOLUTION_RESOLVES: ROUTE_FILTERED,
            PIPELINE_RESULT_CODE_DNS_HOST_RESOLUTION_RESOLVED_WITHOUT_IP_ADDRESSES: ROUTE_REVIEW,
            PIPELINE_RESULT_CODE_DNS_HOST_RESOLUTION_TIMEOUT: ROUTE_REVIEW,
            PIPELINE_RESULT_CODE_DNS_HOST_RESOLUTION_SERVFAIL: ROUTE_REVIEW,
