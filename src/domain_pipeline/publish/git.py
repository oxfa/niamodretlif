"""Small git helpers for workflow-safe publish commits."""
...
def prepare_publish_worktree(
    ...
    *,
    ...
    """Prepare one dedicated publish worktree without switching the main checkout."""
