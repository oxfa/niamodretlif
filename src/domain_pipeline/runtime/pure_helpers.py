...
def public_review_classification(row: dict[str, Any]) -> str:
    ...
    if classification == CLASSIFICATION_DNS_DELEGATION_TIMEOUT:
        return REVIEW_CLASSIFICATION_DNS_DELEGATION_TIMEOUT
    if classification == CLASSIFICATION_DNS_DELEGATION_SERVFAIL:
        return REVIEW_CLASSIFICATION_DNS_DELEGATION_SERVFAIL
